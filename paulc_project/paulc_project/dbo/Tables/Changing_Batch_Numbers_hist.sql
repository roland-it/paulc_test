CREATE TABLE [dbo].[Changing_Batch_Numbers_hist] (
    ...
    [load_date] DATETIME        CONSTRAINT [DF_Changing_Batch_Numbers_load_date_Hist2] DEFAULT (getdate()) NULL,
    [AX_Batch]  VARCHAR (500)   NULL,
    CONSTRAINT [PK_Changing_Batch_Numbers_Hist2] PRIMARY KEY CLUSTERED ([change_id] ASC)
);
