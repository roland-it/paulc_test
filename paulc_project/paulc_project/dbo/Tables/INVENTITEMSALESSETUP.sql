CREATE TABLE [dbo].[INVENTITEMSALESSETUP] (
    ...
    [OVERRIDESALESLEADTIME]      INT              DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [I_1764ITEMDIMIDX] PRIMARY KEY CLUSTERED ([PARTITION] ASC, [DATAAREAID] ASC, [ITEMID] ASC, [INVENTDIMID] ASC),
    CHECK ([RECID]<>(0))
);
