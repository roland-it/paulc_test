...
-- =============================================
CREATE PROCEDURE [dbo].[prTLE_Summary_Upsert]
AS
BEGIN
	SET NOCOUNT ON;
...
SELECT DISTINCT [execution_date]
           ,[PO_ID]
           ,[PO_NUM], 0
  FROM [datarepo].[dbo].[L3_VP_TLESummary]
...
--UPDATE OLD
    ...
    UPDATE OLD SET
	 ...
	 FROM  [Vp_tmpTLESummary_History] OLD INNER JOIN  [L3_VP_TLESummary] NW
